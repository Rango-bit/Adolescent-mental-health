...
from configs import SerializerConfig
...
_SPECIAL_TOKENS_MAP = {
    ...
    "feature_start_token": tok.FEATURE_START_TOKEN,
    "feature_end_token": tok.FEATURE_END_TOKEN,
    "shared_start_token": tok.SHARED_START_TOKEN,
    "shared_end_token": tok.SHARED_END_TOKEN,
    "different_start_token": tok.DIFFERENT_START_TOKEN,
    "different_end_token": tok.DIFFERENT_END_TOKEN,
    "q_start_token": tok.Q_START_TOKEN,
    "q_end_token": tok.Q_END_TOKEN,
    "a_start_token": tok.A_START_TOKEN,
    "a_end_token": tok.A_END_TOKEN,
